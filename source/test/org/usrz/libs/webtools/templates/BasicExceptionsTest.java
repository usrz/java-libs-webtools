...
public class BasicExceptionsTest extends AbstractTest {
    ...
    throws Exception {
        assertResponse("/fail/template?p=%3Cdiv+class=%22foobar%22%2F%3E", "text/html;q=0.9,application/json;q=0.1", "text/html",
                       ...
                       + UUID_PATTERN + "</dd><dt>Exception:</dt><dd>org.usrz.libs.webtools.mustache.TemplatedException</dd></dl></body></html>");
    }
